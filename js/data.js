...
var GOLDEN_PICKLE_DATA = {
  ...
  bracket: [
    ...
    },
    {
      round: "Round 2",
      matches: [
        { teamA: "Heavy Hitters (Aaron Olivas / Jacob Gomez)",            teamB: "Ball Busters (Hagen Tuck / Ej Lopez)",                  scoreA: "", scoreB: "", court: "Court 1", time: "TBD", winner: "Ball Busters (Hagen Tuck / Ej Lopez)" },
        { teamA: "Trace Garcia / Jaden Luebano",                          teamB: "Jack Burgen / Abdi Molinar",                            scoreA: "", scoreB: "", court: "Court 2", time: "TBD", winner: "Trace Garcia / Jaden Luebano" },
        { teamA: "John Brus / Ashur Tellez",                              teamB: "The Shabooms (Tatum Holley / Max Rosales)",             scoreA: "", scoreB: "", court: "Court 3", time: "TBD", winner: "John Brus / Ashur Tellez" },
        { teamA: "Vortex (Eddie Herrera / Maverick Torres)",              teamB: "Court Crushers (Annika Armendariz / Connor Hendricks)", scoreA: "", scoreB: "", court: "Court 1", time: "TBD", winner: "Court Crushers (Annika Armendariz / Connor Hendricks)" },
        { teamA: "Big Dink Energy (Hailey Gribble / Aaron Franco)",       teamB: "Daniel reyes / Nomar Gomez",                            scoreA: "", scoreB: "", court: "Court 2", time: "TBD", winner: "Daniel reyes / Nomar Gomez" },
        { teamA: "The Pickles (Cain Gomez / Aiden Molinar)",              teamB: "Angel Granados / Jorge Molinar",                        scoreA: "", scoreB: "", court: "Court 3", time: "TBD", winner: "Angel Granados / Jorge Molinar" },
        { teamA: "Team critic (Angel Flores / Faryah nasrudin)",          teamB: "Dan Swartzlander / Misa Gomez",                         scoreA: "", scoreB: "", court: "Court 1", time: "TBD", winner: "Team critic (Angel Flores / Faryah nasrudin)" },
        { teamA: "Team Kenobi (Kyle Covington / Jackson Ortiz)",          teamB: "Slix fitz (Eva Flores / Sloan Riordan)",                scoreA: "", scoreB: "", court: "Court 2", time: "TBD", winner: "Team Kenobi (Kyle Covington / Jackson Ortiz)" }
      ]
    },
    {
      round: "Round 3",
      matches: [
        { teamA: "Angel Granados / Jorge Molinar",                        teamB: "Team critic (Angel Flores / Faryah nasrudin)",          scoreA: "", scoreB: "", court: "Court 1", time: "TBD", winner: "Team critic (Angel Flores / Faryah nasrudin)" },
        { teamA: "Daniel reyes / Nomar Gomez",                            teamB: "Trace Garcia / Jaden Luebano",                          scoreA: "", scoreB: "", court: "Court 2", time: "TBD", winner: "Trace Garcia / Jaden Luebano" },
        { teamA: "Ball Busters (Hagen Tuck / Ej Lopez)",                  teamB: "Court Crushers (Annika Armendariz / Connor Hendricks)", scoreA: "", scoreB: "", court: "Court 3", time: "TBD", winner: "Ball Busters (Hagen Tuck / Ej Lopez)" },
        { teamA: "John Brus / Ashur Tellez",                              teamB: "Team Kenobi (Kyle Covington / Jackson Ortiz)",          scoreA: "", scoreB: "", court: "Court 1", time: "TBD", winner: "Team Kenobi (Kyle Covington / Jackson Ortiz)" }
      ]
    },
    {
      round: "Round 4",
      matches: [
        { teamA: "Trace Garcia / Jaden Luebano",                          teamB: "Team Kenobi (Kyle Covington / Jackson Ortiz)",          scoreA: "", scoreB: "", court: "Court 1", time: "TBD", winner: "Team Kenobi (Kyle Covington / Jackson Ortiz)" },
        { teamA: "Team critic (Angel Flores / Faryah nasrudin)",          teamB: "Ball Busters (Hagen Tuck / Ej Lopez)",                  scoreA: "", scoreB: "", court: "Court 2", time: "TBD", winner: "Ball Busters (Hagen Tuck / Ej Lopez)" }
      ]
    },
    {
      round: "Round 5",
      matches: [
        { teamA: "Team Kenobi (Kyle Covington / Jackson Ortiz)",          teamB: "Ball Busters (Hagen Tuck / Ej Lopez)",                  scoreA: "", scoreB: "", court: "Court 1", time: "TBD", winner: "Ball Busters (Hagen Tuck / Ej Lopez)" }
      ]
    },
  ],
  ...
  resultsReady: true,
  results: {
    champion: { team: "Ball Busters (Hagen Tuck / Ej Lopez)", players: "Hagen Tuck & Ej Lopez", photo: "images/first_place.jpg" },
    runnerUp: { team: "Team Kenobi (Kyle Covington / Jackson Ortiz)", players: "Kyle Covington & Jackson Ortiz", photo: "images/second_place.jpg" },
    placements: [
      { place: "3rd", team: "Team critic (Angel Flores / Faryah nasrudin)", photo: "images/third_place.jpg" }
    ]
  },
  ...
  announcement: {
    ...
    message: "Thank you to everyone that participated in The First Annual <span class=\"gold-text\">Golden Pickle</span>. This could not have been done without you, the players. Congratulations to our winners!"
  }
};
