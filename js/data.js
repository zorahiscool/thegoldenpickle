...
var GOLDEN_PICKLE_DATA = {
  ...
  resultsReady: true,
  results: {
    champion: { team: "Ball Busters (Hagen Tuck / Ej Lopez)", players: "Hagen Tuck & Ej Lopez" },
    runnerUp: { team: "Team Kenobi (Kyle Covington / Jackson Ortiz)", players: "Kyle Covington & Jackson Ortiz" },
    placements: [
      { place: "3rd", team: "Team critic (Angel Flores / Faryah nasrudin)" }
    ]
  },
